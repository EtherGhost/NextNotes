...
class ProjectMetadataTests(unittest.TestCase):
    def test_manifest_identity_and_version_are_consistent(self):
        ...
        self.assertIn('set(NEXTNOTES_VERSION "0.2.0")', cmake)
    ...
    def test_content_hub_import_is_declared_as_share_destination(self):
        ...
        self.assertNotIn("onHasPendingChanged", handler)
        self.assertNotIn("onHasPendingChanged", fallback_handler)
        ...
        self.assertIn("function wasTransferProcessed", handler)
        self.assertIn("function wasContentProcessed", handler)
        self.assertIn("contentKey(content)", handler)
        self.assertIn("import skipped duplicate content", handler)
